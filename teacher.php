...
<body class="bg-light">
    ...
    <div class="container bg-dark text-light p-3 rounded my-4">
        <div class="d-flex align-items-center justify-content-between px-3">
            <h2><a class="text-white text-decoration-none" href="index.php">Teacher Panel</a></h2>
        ...
        <table class="table table-hover text-center">
            <thead class="bg-dark text-light">
                <tr>
                    ...
                    <th width="15%" scope="col">Depertment</th>
                    <th width="15%" scope="col">Course Name</th>
                ...
                while($fetch=mysqli_fetch_assoc($result))
                {
                    echo<<<teacher
                        <tr class="align-middle">
                            <th scope="row">$i</th>
                            <td><img src="$fetch_src$fetch[t_image]" width="150px"></td>
                            <td>$fetch[t_name]</td>
                            <td>$fetch[t_dept]</td>
                            <td>$fetch[t_c_name]</td>
                            <td>$fetch[t_email]</td>
                            <td>$fetch[t_phone]</td>
                            <td>
    ...
    <div class="modal fade" id="addteacher" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            ...
            <form action="t_crud.php" method="POST" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-5">Add Teacher</h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text">Depertment</span>
                            <input type="text" class="form-control" name="t_dept" required>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Phone</span>
                            <input type="number" class="form-control" name="t_phone" required>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Course Name</span>
                            <input type="text" class="form-control" name="t_c_name" required>
                        </div>
                        <div class="input-group mb-3">
                            <label class="input-group-text">Image</label>
                            <input type="file" class="form-control" name="t_image" accept=".jpg, .png, .svg" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="reset" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-success" name="addteacher">Add</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal fade" id="editteacher" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            ...
            <form action="t_crud.php" method="POST" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-5">Edit Teacher</h5>
                    </div>
                    <div class="modal-body">
                        <div class="input-group mb-3">
                            <span class="input-group-text">Name</span>
                            <input type="text" class="form-control" name="t_name" id="editname" required>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Email</span>
                            <input type="email" class="form-control" name="t_email" id="editemail" required>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Depertment</span>
                            <input type="text" class="form-control" name="t_dept" id="editdept" required>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Course Name</span>
                            <input type="text" class="form-control" name="t_c_name" id="editt_c_name" required>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Phone</span>
                            <input type="number" class="form-control" name="t_phone" id="editphone" required>
                        </div>
                        <img src="" id="editimg" width="100%" class="mb-3"><br>
                        <div class="input-group mb-3">
                            <label class="input-group-text">Image</label>
                            <input type="file" class="form-control" name="t_image" accept=".jpg, .png, .svg, .jpeg">
                        </div>
                        <input type="hidden" name="editpid" id="editpid">
                    </div>
                    <div class="modal-footer">
                        <button type="reset" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-success" name="editteacher">Edit</button>
                    </div>
                </div>
            </form>
        </div>
